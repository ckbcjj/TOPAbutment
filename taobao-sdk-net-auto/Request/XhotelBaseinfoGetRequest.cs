...
{
    /// <summary>
    /// TOP API: taobao.xhotel.baseinfo.get
    /// </summary>
    public class XhotelBaseinfoGetRequest : BaseTopRequest<Top.Api.Response.XhotelBaseinfoGetResponse>
    {
        /// <summary>
        /// 淘宝酒店ID
        /// </summary>
        ...
        /// </summary>
        public Nullable<bool> IsNeedRoomType { get; set; }
        ...
        public override IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("is_need_room_type", this.IsNeedRoomType);
