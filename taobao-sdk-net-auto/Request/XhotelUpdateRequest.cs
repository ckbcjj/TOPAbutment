...
{
    /// <summary>
    /// TOP API: taobao.xhotel.update
    /// </summary>
    public class XhotelUpdateRequest : BaseTopRequest<Top.Api.Response.XhotelUpdateResponse>
    {
        /// <summary>
        /// 酒店地址。长度不能超过120
        /// </summary>
        ...
        /// <summary>
        /// 城市编码。参见：http://kezhan.trip.taobao.com/area.html，domestic为false时，输入对应国家的海外城市编码，可调用海外城市查询接口获取；（新增酒店时为必须）
        /// </summary>
        ...
        public override void Validate()
        {
            ...
            RequestValidator.ValidateMaxLength("vendor", this.Vendor, 64);
        }
