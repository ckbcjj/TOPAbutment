...
{
    /// <summary>
    /// TOP API: taobao.xhotel.rates.increment
    /// </summary>
    public class XhotelRatesIncrementRequest : BaseTopRequest<Top.Api.Response.XhotelRatesIncrementResponse>
    {
        /// <summary>
        ...
        /// </summary>
        public string RateInventoryPriceMap { get; set; }
        ...
        public override IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("rate_inventory_price_map", this.RateInventoryPriceMap);
        ...
        {
            RequestValidator.ValidateRequired("rate_inventory_price_map", this.RateInventoryPriceMap);
        }
